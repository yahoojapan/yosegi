...
public class TestColumnBinaryMakerConfig{
  ...
  private static Stream<Arguments> parametersForT_getColumnMaker_1(){
    return Stream.of(
      ...
      arguments( ColumnType.FLOAT , OptimizedNullArrayDumpFloatColumnBinaryMaker.class.getName() ),
      arguments( ColumnType.INTEGER , OptimizedNullArrayDumpLongColumnBinaryMaker.class.getName() ),
      arguments( ColumnType.LONG , OptimizedNullArrayDumpLongColumnBinaryMaker.class.getName() ),
      arguments( ColumnType.SHORT , OptimizedNullArrayDumpLongColumnBinaryMaker.class.getName() ),
      arguments( ColumnType.STRING , OptimizedNullArrayDumpStringColumnBinaryMaker.class.getName() ),
