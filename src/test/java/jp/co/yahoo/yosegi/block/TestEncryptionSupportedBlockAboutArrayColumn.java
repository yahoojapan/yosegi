...
public class TestEncryptionSupportedBlockAboutArrayColumn {
  ...
  public void T_encryptColumn_equalsSetValue_withAllBlock() throws IOException {
    ...
    while ( reader.hasNext() ) {
      ...
      IColumn col3ParentOriginal = s1.getColumn( "col3" );
      IColumn col3Original = col3ParentOriginal.getColumn( 0 );
      IColumn col3Parent = s.getColumn( "col3" );
      IColumn col3 = col3Parent.getColumn( 0 );

      for ( int i = 0 ; i < col3Original.size() ; i++ ) {
        assertEquals( ( (PrimitiveObject)( col3.get(i).getRow() ) ).getString() ,
            ( (PrimitiveObject)( col3Original.get(i).getRow() ) ).getString() );
      }
    }
    ...
    while ( reader.hasNext() ) {
      Spread s = reader.next();
      IColumn col3ParentOriginal = s2.getColumn( "col3" );
      IColumn col3Original = col3ParentOriginal.getColumn( 0 );
      IColumn col3Parent = s.getColumn( "col3" );
      IColumn col3 = col3Parent.getColumn( 0 );
    ...
    while ( reader.hasNext() ) {
      Spread s = reader.next();
      IColumn col3ParentOriginal = s3.getColumn( "col3" );
      IColumn col3Original = col3ParentOriginal.getColumn( 0 );
      IColumn col3Parent = s.getColumn( "col3" );
      IColumn col3 = col3Parent.getColumn( 0 );
  ...
  public void T_encryptColumn_valueIsNull_withInvalidKey() throws IOException {
    ...
    while ( reader.hasNext() ) {
      Spread s = reader.next();
      assertFalse( s.containsColumn( "col3" ) );
      IColumn col3Original = s1.getColumn( "col3" );
      IColumn col3 = s.getColumn( "col3" );

      assertNull( col3.get(0).getRow() );
      assertNull( col3.get(1).getRow() );
      assertNull( col3.get(2).getRow() );
    }
  }
