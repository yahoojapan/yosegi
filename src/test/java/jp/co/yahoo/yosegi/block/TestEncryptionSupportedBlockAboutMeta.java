...
public class TestEncryptionSupportedBlockAboutMeta {
  ...
  public String getKeyStoreJsonWithInvalidKey() {
    ...
    keyStoreJson +=     "\"class\":\"jp.co.yahoo.yosegi.keystore.Base64TextKeyProvider\",";
    keyStoreJson +=     "\"config\":{";
    keyStoreJson +=       "\"text\":\"A2VyY3JldGtleWFlczEyOA==\"";
    keyStoreJson +=     "}";
    keyStoreJson +=   "}";
    keyStoreJson += "]";
    return keyStoreJson;
  ...
  public String getMetaEncryptionJson() {
    String json = "";
    json += "{";
    json +=   "\"meta\":{";
    json +=     "\"key_name\":\"key_1\"";
  ...
  public Configuration getWriteConfig() {
    ...
    config.set( "block.encrypt.setting" , getMetaEncryptionJson() );
  ...
  @Test
  public void T_encryptMeta_equalsSetValue_withAllBlock() throws IOException {
  ...
  @Test
  public void T_encryptMeta_throwException_withInvalidKey() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
    writer.setup( BLOCK_SIZE , getWriteConfig() );
  ...
  @Test
  public void T_encryptMeta_throwException_withNoKey() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
    writer.setup( BLOCK_SIZE , getWriteConfig() );
  ...
  @Test
  public void T_encryptMeta_throwException_withAadPrefix() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
    writer.setup( BLOCK_SIZE , getWriteConfig() );
  ...
  @Test
  public void T_encryptMetaWithAadPrefix_equalsSetValue_withAllBlock() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
  ...
  @Test
  public void T_encryptMetaWithAadPrefix_throwException_withInvalidKey() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
    writer.setup( BLOCK_SIZE , getWriteConfigWithAadPrefix() );
  ...
  @Test
  public void T_encryptMetaWithAadPrefix_throwException_withNoKey() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
    writer.setup( BLOCK_SIZE , getWriteConfigWithAadPrefix() );
  ...
  @Test
  public void T_encryptMetaWithAadPrefixAndDisableAadPrefix_equalsSetValue_withAllBlock() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
  ...
  @Test
  public void T_encryptMetaWithAadPrefixAndDisableWrite_throwException_whenExternalAadPrefixNotFound() throws IOException {
    EncryptionSupportedBlockWriter writer = new EncryptionSupportedBlockWriter();
    writer.setup( BLOCK_SIZE , getWriteConfigWithAadPrefixAndDisableWrite() );
