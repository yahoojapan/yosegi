...
public class TestByteField {
  ...
  public void T_createNewInstance_void_withFieldName() {
    IField field = new ByteField( "test" );
  }
  ...
  public void T_createNewInstance_void_withFieldNameAndProperties() {
    ...
    IField field = new ByteField( "test" , prop );
  }
  ...
  @Test
  public void T_getFieldType_typeIsBytes() {
    IField field = new ByteField( "test" );
    assertEquals( FieldType.BYTE , field.getFieldType() );
  }
