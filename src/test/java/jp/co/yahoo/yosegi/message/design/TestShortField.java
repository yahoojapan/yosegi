...
public class TestShortField {
  ...
  public void T_createNewInstance_void_withFieldName() {
    IField field = new ShortField( "test" );
  }
  ...
  public void T_createNewInstance_void_withFieldNameAndProperties() {
    ...
    IField field = new ShortField( "test" , prop );
  }
  ...
  @Test
  public void T_getFieldType_typeIsShort() {
    IField field = new ShortField( "test" );
    assertEquals( FieldType.SHORT , field.getFieldType() );
  }
