...
public class TestBytesColumnAnalizeResult {

  @Test
  public void T_getAnalizer_1() throws IOException{
    BytesColumnAnalizeResult result = new BytesColumnAnalizeResult( "name" , 100 , true , 10 , 90 , 2 , 90 , 40 , 50 );
    assertEquals( "name" , result.getColumnName() );
    assertEquals( ColumnType.BYTES , result.getColumnType() );
    ...
    assertEquals( 40 , result.getMinBytes() );
    assertEquals( 50 , result.getMaxBytes() );
  }
