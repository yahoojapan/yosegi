...
public class TestIntegerColumnAnalizeResult {
  ...
  public void T_getAnalizer_1() throws IOException{
    ...
    assertEquals( Integer.BYTES * 90 , result.getLogicalDataSize() );
    assertEquals( (int)40 , result.getMin() );
    assertEquals( (int)50 , result.getMax() );
  }
