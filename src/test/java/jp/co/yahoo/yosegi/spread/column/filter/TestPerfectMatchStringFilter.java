...
public class TestPerfectMatchStringFilter {
    
    @Test
    public void T_constractNotException() {
        new PerfectMatchStringFilter("string");
        new PerfectMatchStringFilter("");
        new PerfectMatchStringFilter(null);
    }

    @Test
    public void T_getSearchString() {
        PerfectMatchStringFilter target1 = new PerfectMatchStringFilter("string");
        PerfectMatchStringFilter target2 = new PerfectMatchStringFilter("");
        PerfectMatchStringFilter target3 = new PerfectMatchStringFilter(null);
    ...
    public void T_getStringFilterType() {
        PerfectMatchStringFilter target = new PerfectMatchStringFilter("string");
