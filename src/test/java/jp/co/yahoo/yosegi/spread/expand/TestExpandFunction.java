...
public class TestExpandFunction {

    @Test
    public void T_getExpandColumnName() throws IOException {
        ...
        assertEquals(ExpandFunctionFactory.get(conf).getExpandColumnName().get(0)[0], "val_node");
    }
