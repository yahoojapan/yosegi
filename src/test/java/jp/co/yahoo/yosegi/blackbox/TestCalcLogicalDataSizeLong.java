...
public class TestCalcLogicalDataSizeLong {
  ...
  public void T_notNull_2( final String targetClassName ) throws IOException {
    ...
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 2 );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 3 );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 4 );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 5 );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 6 );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 7 );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 8 );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 9 );
  ...
  public void T_hasNull_1( final String targetClassName ) throws IOException {
    IColumn column = new PrimitiveColumn( ColumnType.LONG , "column" );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 1 );
    column.add( ColumnType.LONG , new LongObj( (long)2 ) , 2 );
    column.add( ColumnType.LONG , new LongObj( (long)3 ) , 4 );
    column.add( ColumnType.LONG , new LongObj( (long)4 ) , 5 );

    ColumnBinary columnBinary = create( column , targetClassName );
    assertEquals( columnBinary.logicalDataSize , Long.BYTES * 4 );
  }
  ...
  public void T_hasNull_2( final String targetClassName ) throws IOException {
    IColumn column = new PrimitiveColumn( ColumnType.LONG , "column" );
    column.add( ColumnType.LONG , new LongObj( (long)1 ) , 5 );
    column.add( ColumnType.LONG , new LongObj( (long)2 ) , 6 );
