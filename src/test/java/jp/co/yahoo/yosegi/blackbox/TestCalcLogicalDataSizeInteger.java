...
public class TestCalcLogicalDataSizeInteger {
  ...
  public void T_notNull_1( final String targetClassName ) throws IOException {
    ...
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 0 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)2 ) , 1 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)3 ) , 2 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)4 ) , 3 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)5 ) , 4 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)6 ) , 5 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)7 ) , 6 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)8 ) , 7 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)9 ) , 8 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)10 ) , 9 );

    ColumnBinary columnBinary = create( column , targetClassName );
    assertEquals( columnBinary.logicalDataSize , Integer.BYTES * 10 );
  }
  ...
  public void T_notNull_2( final String targetClassName ) throws IOException {
    ...
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 3 );
    ...
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 7 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 8 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 9 );
  ...
  public void T_hasNull_1( final String targetClassName ) throws IOException {
    IColumn column = new PrimitiveColumn( ColumnType.INTEGER , "column" );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 1 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)2 ) , 2 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)3 ) , 4 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)4 ) , 5 );
  ...
  public void T_hasNull_2( final String targetClassName ) throws IOException {
    IColumn column = new PrimitiveColumn( ColumnType.INTEGER , "column" );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 5 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)2 ) , 6 );
  ...
  public void T_hasNull_3( final String targetClassName ) throws IOException {
    IColumn column = new PrimitiveColumn( ColumnType.INTEGER , "column" );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)1 ) , 1 );
    column.add( ColumnType.INTEGER , new IntegerObj( (int)2 ) , 5 );
