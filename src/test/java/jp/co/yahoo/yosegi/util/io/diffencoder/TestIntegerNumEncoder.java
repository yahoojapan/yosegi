...
public class TestIntegerNumEncoder {

  @Test
  public void T_calcBinarySize_equals() throws IOException {
    IntegerNumEncoder encoder = new IntegerNumEncoder( Integer.MIN_VALUE , Integer.MAX_VALUE );
    assertEquals( encoder.calcBinarySize( 10 ) , 42 );
  }
  ...
  public void T_toBinaryAndtoPrimitiveArrayWithJavaLong_equalsSetValue() throws IOException {
    ...
    Long[] valueArray = new Long[]{
      Long.valueOf( 0L ),
      Long.valueOf( (long)Integer.MAX_VALUE ),
      Long.valueOf( (long)Integer.MIN_VALUE ),
      Long.valueOf( 1L ),
      Long.valueOf( 2L ),
      Long.valueOf( 3L ),
      Long.valueOf( 4L ),
