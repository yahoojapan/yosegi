...
public class TestShortNumEncoder {

  @Test
  public void T_calcBinarySize_equals() throws IOException {
    ShortNumEncoder encoder = new ShortNumEncoder();
    assertEquals( encoder.calcBinarySize( 10 ) , 20 );
  }
  ...
  public void T_toBinaryAndtoPrimitiveArrayWithJavaLong_equalsSetValue() throws IOException {
    ...
    Long[] valueArray = new Long[]{
      Long.valueOf( 0L ),
      Long.valueOf( (long)Short.MAX_VALUE ),
      Long.valueOf( (long)Short.MIN_VALUE ),
      Long.valueOf( 1L ),
      Long.valueOf( 2L ),
      Long.valueOf( 3L ),
      Long.valueOf( 4L ),
