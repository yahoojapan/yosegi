...
public class ArrowSequentialDoubleLoader implements ISequentialLoader<ValueVector> {
   ...
   */
  public ArrowSequentialDoubleLoader( final ValueVector vector , final int loadSize ) {
