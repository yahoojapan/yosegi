...
public class ArrowDictionaryStringLoader implements IDictionaryLoader<ValueVector> {
   ...
   */
  public ArrowDictionaryStringLoader( final ValueVector vector , final int loadSize ) {
