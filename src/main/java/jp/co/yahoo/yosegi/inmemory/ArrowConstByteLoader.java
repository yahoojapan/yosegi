...
public class ArrowConstByteLoader implements IConstLoader<ValueVector> {
   ...
   */
  public ArrowConstByteLoader( final ValueVector vector , final int loadSize ) {
