...
public class ArrowDictionaryShortLoader implements IDictionaryLoader<ValueVector> {
   ...
   */
  public ArrowDictionaryShortLoader( final ValueVector vector , final int loadSize ) {
  ...
  private void setDownCastOrNull( final int index , final PrimitiveObject obj ) throws IOException {
    try {
      setShortToDic( index , obj.getShort() );
