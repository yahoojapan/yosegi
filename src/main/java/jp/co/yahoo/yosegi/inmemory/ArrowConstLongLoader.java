...
public class ArrowConstLongLoader implements IConstLoader<ValueVector> {
   ...
   */
  public ArrowConstLongLoader( final ValueVector vector , final int loadSize ) {
