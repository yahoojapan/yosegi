...
public class ArrowConstShortLoader implements IConstLoader<ValueVector> {
   ...
   */
  public ArrowConstShortLoader( final ValueVector vector , final int loadSize ) {
  ...
  private void setDownCastOrNull( final PrimitiveObject obj ) throws IOException {
    try {
      setConstFromShort( obj.getShort() );
