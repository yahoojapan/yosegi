...
public class ArrowConstIntegerLoader implements IConstLoader<ValueVector> {
   ...
   */
  public ArrowConstIntegerLoader( final ValueVector vector , final int loadSize ) {
  ...
  public void setConstFromFloat( final float value ) throws IOException {
    setDownCastOrNull( new FloatObj( value ) );
  }
  ...
  private void setDownCastOrNull( final PrimitiveObject obj ) throws IOException {
    try {
      setConstFromInteger( obj.getInt() );
