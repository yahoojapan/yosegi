...
public class ArrowFixedSchemaArrayMemoryAllocator implements IMemoryAllocator {
  ...
  @Override
  public IMemoryAllocator getArrayChild(
      final int childLength , final ColumnType type ) throws IOException {
    return ArrowFixedSchemaMemoryAllocatorFactory.getFromListVector(
        childSchema , "ARRAY_CHILD" , allocator , vector , childLength );
  }
